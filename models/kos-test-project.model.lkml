...
explore: google_group {
  ...
  join: group {
    type: left_outer
    sql_on: ${google_group.group_id} = ${group.external_group_id} ;;
    relationship: many_to_one
  }
...
explore: google_groups_sync_status {
  join: user {
    type: left_outer
    sql_on: ${google_groups_sync_status.user_id} = ${user.dev_mode_user_id} ;;
    relationship: many_to_one
  }
...
explore: materialized_visible_content {
  ...
  join: user {
    type: left_outer
    sql_on: ${materialized_visible_content.user_id} = ${user.dev_mode_user_id} ;;
    relationship: many_to_one
  }
...
explore: user_ide_project_state {
  join: user {
    type: left_outer
    sql_on: ${user_ide_project_state.user_id} = ${user.dev_mode_user_id} ;;
    relationship: many_to_one
  }
...
explore: user_ide_state {
  join: user {
    type: left_outer
    sql_on: ${user_ide_state.user_id} = ${user.dev_mode_user_id} ;;
    relationship: many_to_one
  }
